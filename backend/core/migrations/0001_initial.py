# Generated by Django 4.2.11 on 2026-07-12 11:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('idle', 'Ожидание'), ('scanning', 'Сканирование'), ('uploading', 'Отправка'), ('error', 'Ошибка')], default='idle', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heartbeats', to='core.agent')),
            ],
            options={
                'ordering': ['-timestamp'],
            },
